    ...
    private class ServerTask extends AsyncTask<ServerSocket, String, Void> {
        ...
        protected Void doInBackground(ServerSocket... sockets) {
            ...
            try {
                ...
                while ((data = in.readLine()) != null) { // Receive data when not null
                    Log.i(TAG,data + "message received");
                    publishProgress(data); //Publishes updates on the UI. Invokes onProgressUpdate() everytime publishProgress() is called.
        ...
        protected Void doInBackground(String... msgs) {
            try {
                ...
                Socket socket = new Socket(InetAddress.getByAddress(new byte[]{10, 0, 2, 2}),
                        Integer.parseInt(remotePort)); // Establishes a new socket creation for client/server communication
                ...
                out.println(msgToSend); //Display message on the screen
                //socket.close(); //helps receive the second message without varying consistency
                // Reference: https://docs.oracle.com/javase/tutorial/networking/sockets/definition.html
